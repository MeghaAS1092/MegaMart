...
export default function HeaderComponent() {
  const { count } = useCart();
  return (
    <div className="fixed top-0 left-0 w-full bg-white shadow-md p-4 z-50 h-22 flex items-center justify-between">
      <ul className="flex justify-between items-center">
        <li className="px-4">
          <Link href="/" passHref>
            <Image src="/logo.png" alt="App logo" width={200} height={80} className="!h-[90px] w-auto"/>
          </Link>
        </li>
        {/* Shop with dropdown */}
